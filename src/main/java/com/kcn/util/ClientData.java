...
public class ClientData implements CommandMethod, StrongRecipe, Dust{
    ...
    public static void addDust() {
        Dust.add(Main.ESSENCE_STONE, Main.ESSENCE_DUST);
        Dust.add(Items.IRON_INGOT, Main.IRON_DUST);
        Dust.add(Items.GOLD_INGOT, Main.GOLD_DUST);
        Dust.add(Items.DIAMOND, Main.DIAMOND_DUST);
        Dust.add(Items.LAPIS_LAZULI, Main.LAPIS_LAZULI_DUST);
        Dust.add(Items.COAL, Main.COAL_DUST);
        Dust.add(Items.EMERALD, Main.EMERALD_DUST);
        Dust.add(Items.COPPER_INGOT, Main.COPPER_DUST);
        Dust.add(Tags.ORES, Tags.DUSTED_ITEM, Main.CRUSHED_STONE);
        Dust.add(Tags.DEEPSLATE_ORES, Tags.DUSTED_ITEM, Main.CRUSHED_DEEPSLATE_STONE);
    }

    public static void addStrongRecipe() {
        StrongRecipe.add(Items.IRON_INGOT, Main.IRON_SHEET);
        StrongRecipe.add(Items.GOLD_INGOT, Main.GOLD_SHEET);
    }
